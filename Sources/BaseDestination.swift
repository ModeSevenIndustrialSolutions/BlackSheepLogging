...
open class BaseDestination: Hashable, Equatable {
    ...
    open var minLevel = BlackSheepLogging.Level.verbose
    ...
    public init() {
        ...
        let queueLabel = "blacksheeplogging-queue-" + uuid
    ...
    open func send(_ level: BlackSheepLogging.Level, msg: String, thread: String, file: String,
    ...
    func formatMessage(_ format: String, level: BlackSheepLogging.Level, msg: String, thread: String,
    ...
    func messageToJSON(_ level: BlackSheepLogging.Level, msg: String,
    ...
    func levelWord(_ level: BlackSheepLogging.Level) -> String {
    ...
    func colorForLevel(_ level: BlackSheepLogging.Level) -> String {
        var color = ""
    ...
    func shouldLevelBeLogged(_ level: BlackSheepLogging.Level, path: String,
