...
class BaseDestinationTests: XCTestCase {
    ...
    func testMessageToJSON() {
        ...
        XCTAssertEqual(level, BlackSheepLogging.Level.info.rawValue)
    ...
    func testLevelWord() {
        ...
        str = obj.levelWord(BlackSheepLogging.Level.verbose)
        XCTAssertNotNil(str, "VERBOSE")
        str = obj.levelWord(BlackSheepLogging.Level.debug)
        XCTAssertNotNil(str, "DEBUG")
        str = obj.levelWord(BlackSheepLogging.Level.info)
        XCTAssertNotNil(str, "INFO")
        str = obj.levelWord(BlackSheepLogging.Level.warning)
        XCTAssertNotNil(str, "WARNING")
        str = obj.levelWord(BlackSheepLogging.Level.error)
    ...
    func testColorForLevel() {
        ...
        // empty on default
        str = obj.colorForLevel(BlackSheepLogging.Level.verbose)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(BlackSheepLogging.Level.debug)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(BlackSheepLogging.Level.info)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(BlackSheepLogging.Level.warning)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(BlackSheepLogging.Level.error)
        XCTAssertNotNil(str, "")
    ...
    func test_init_noMinLevelSet() {
        ...
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.verbose, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.error, path: "", function: ""))
    }

    func test_init_minLevelSet() {
        let destination = BaseDestination()
        destination.minLevel = BlackSheepLogging.Level.info
        XCTAssertFalse(destination.shouldLevelBeLogged(BlackSheepLogging.Level.verbose, path: "", function: ""))
        XCTAssertFalse(destination.shouldLevelBeLogged(BlackSheepLogging.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.error, path: "", function: ""))
    }
    ...
    func test_shouldLevelBeLogged_hasMinLevel_True() {
        let destination = BaseDestination()
        destination.minLevel = BlackSheepLogging.Level.verbose
        destination.addFilter(Filters.Path.equals("/world/beaver.swift", caseSensitive: true, required: true))
        XCTAssertTrue(destination.shouldLevelBeLogged(BlackSheepLogging.Level.warning,
    ...
    func test_shouldLevelBeLogged_hasMinLevelAndOneRequiredMessageFilterAndDoesPass_True() {
        let destination = BaseDestination()
        destination.minLevel = BlackSheepLogging.Level.error
        destination.addFilter(Filters.Message.contains("Required", caseSensitive: false, required: true, minLevel: .info))
    ...
    func jsonStringFromDict(_ dict: [String: Any]) -> String? {
        ...
        do {
            ...
            print("BlackSheepLogging could not create JSON from dict.")
        }
        return jsonString
    }
